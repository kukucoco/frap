/*
 * tool_highlight —— 插件模板：荧光笔工具
 *
 * 用法：
 *   1. 复制本目录，重命名为你的插件
 *   2. 修改类名 / 插件 id / 名称
 *   3. 构建后把 .so 复制到 ~/.config/frap/plugins/
 */
...
public:
    ...
    {
        return R"([
            {"type":"tool","data":{"id":"tool.highlight","label":"荧光笔","order":50,"interaction":"drag-region"}}
        ])";
    }
